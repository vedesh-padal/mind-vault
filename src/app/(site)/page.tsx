      ...
      <section className="mt-20 px-4 sm:px-6">
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10">
          {PRICING_CARDS.map((card) => (
            <CustomCard
              key={card.planType}
              className={clsx('w-[320px] rounded-2xl dark:bg-black/40 backdrop-blur-3xl relative', { 'border-brand-primaryPurple/70': card.planType === PRICING_PLANS.proplan })}
              cardHeader={
                <CardTitle
