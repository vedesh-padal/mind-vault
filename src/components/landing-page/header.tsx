...
const Header = () => {
  ...
  return (
    <header className='p-4 flex justify-center items-center'>
      <Link href={'/'} className='w-full justify-left flex items-center gap-2' >
        <Image src={Logo} alt="Mind Vault Logo" width={50} height={50} />
        <span className='font-semibold dark:text-white'>MindVault.</span>
      </Link>
