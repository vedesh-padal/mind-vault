...
ALTER TABLE "folders" RENAME COLUMN "worksapce_id" TO "workspace_id";--> statement-breakpoint
ALTER TABLE "folders" DROP CONSTRAINT "folders_worksapce_id_workspaces_id_fk";
--> statement-breakpoint
DO $$ BEGIN
